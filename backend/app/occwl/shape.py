...
class Shape:
    ...
    def occwl_shape(topods_shape):
        ...
        Returns:
            One of
                app.occwl.compound.Compound
                app.occwl.solid.Solid
                app.occwl.face.Face
                app.occwl.edge.Edge
                app.occwl.vertex.Vertex
                app.occwl.wire.Wire
                app.occwl.shell.Shell
        Raises:
            Exception: [description]
        """
        ...
        from app.occwl.vertex import Vertex
        from app.occwl.wire import Wire
        from app.occwl.shell import Shell
